# Generated by Django 3.2.20 on 2023-10-26 11:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_location', models.CharField(error_messages={'unique': 'такая деятельность уже есть'}, max_length=130, unique=True, verbose_name='Вид работы')),
                ('slug', models.SlugField(error_messages={'unique': 'такой slug уже есть'}, max_length=100, unique=True, verbose_name='Уникальный слаг вида образования')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employmentType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_hr.employment', verbose_name='Тип работы')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_hr.location', verbose_name='Вид работы')),
